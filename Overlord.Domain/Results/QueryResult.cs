namespace Overlord.Domain.Results
{
    public static class QueryResult
    {
        ...
        public static QueryResult<TResult> Failure<TResult>(ErrorType errorType, string errorMessage) =>
            Failure<TResult>(default, errorType, errorMessage);

        public static QueryResult<TResult> Failure<TResult>(TResult? result, ErrorType errorType, string errorMessage) =>
